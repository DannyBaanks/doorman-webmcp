...
| Project runs consistently | Official Rules, Functionality | PASS local / PASS interactive | Node mock and public interactive cycle pass; fresh-agent gate remains separate |
| Real WebMCP environment | Official Rules, testing | PASS interactive | Public Chrome session reported `WebMCP available`; add/list/approval/delete cycle passed |
